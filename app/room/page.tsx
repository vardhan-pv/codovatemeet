    ...
    <div className="relative h-[100dvh] bg-[#0B1020] text-[#FFFFFF] flex flex-col justify-between overflow-hidden font-sans selection:bg-[#0B5CFF]/30">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <main className={`flex-1 flex flex-col md:flex-row overflow-hidden relative bg-[#111827] gap-4 ${
          ...
          <div className={`flex-1 min-w-0 h-full relative z-20 ${activeWorkspace === 'none' ? 'hidden' : ''}`}>
          ...
          <div className={`h-full overflow-y-auto transition-all z-10 ${activeWorkspace === 'none' || isWorkspaceMaximized ? 'flex-1' : 'hidden md:block w-full md:w-80 shrink-0'}`}>
            {statusText ? (
            ...
            <>
              <button
                ...
                className={`flex flex-col items-center justify-center px-3 py-1 rounded-xl transition ${
                  activeWorkspace === 'code' ? 'bg-[#0B5CFF] text-[#FFFFFF] font-extrabold shadow-md' : 'hover:bg-[#1A1D24] text-[#9CA3AF] hover:text-[#FFFFFF] font-bold'
                }`}
